async function getMessages() {
    ...
    data = data.messages;
    console.log(data);
    // On vide le contenu actuel du conteneur des messages
    document.getElementById("messages").innerHTML = "";
  
    // On boucle sur les messages et on les ajoute au conteneur
    for (let i = 0; i < data.length; i++) {
      ...
      <div class="bg-white w-full rounded-md shadow-md h-auto py-3 px-3 my-5">
          <div class="w-full h-16 flex items-center flex justify-between ">
              <div class="flex">
              <a href="./profile.php?userid=${message.userid}"><img class="rounded-full w-10 h-10 mr-3" src="${message.profilepicture}" alt="Profile Picture"></a>
                  <div>
